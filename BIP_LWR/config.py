...
class DelCastConfigHolder(LWRConfigHolder):
    """
    Configuration variables for Del Castillo sampler
    """
    def __init__(self, my_analysis_dir, run_num, data_array_dict,
                w_transf_type='inv', upload_to_S3=False, save_chain=True,
                comments="", root_analysis_folder="../", ratio_times_BCs=40, step_save=10, 
                FD_only=False):

        super(DelCastConfigHolder, self).__init__(my_analysis_dir=my_analysis_dir,
                run_num=run_num, data_array_dict=data_array_dict, w_transf_type=w_transf_type,
                upload_to_S3=upload_to_S3, save_chain=save_chain, comments=comments,
                root_analysis_folder=root_analysis_folder, ratio_times_BCs=ratio_times_BCs, 
                step_save=step_save, FD_only=FD_only)
